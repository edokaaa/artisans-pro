...
export class InitialMigration1768837833085 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "service_category_skills" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "name" character varying NOT NULL, "slug" character varying NOT NULL, "service_category_id" uuid, CONSTRAINT "UQ_3777e7e34f175b548d1f1357642" UNIQUE ("slug"), CONSTRAINT "PK_4c97be712d213ece0c4ac9ef0ee" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."service_providers_idtype_enum" AS ENUM('national_id', 'passport', 'drivers_license')`);
        await queryRunner.query(`CREATE TYPE "public"."service_providers_verificationstatus_enum" AS ENUM('pending', 'verified', 'failed')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."offers_status_enum" AS ENUM('pending', 'accepted', 'declined', 'pending_payment', 'payment_made')`);
        ...
        await queryRunner.query(`CREATE TABLE "service_provider_skills" ("service_provider_id" uuid NOT NULL, "service_category_skill_id" uuid NOT NULL, CONSTRAINT "PK_b59c9b02c480a82d98f79851b7b" PRIMARY KEY ("service_provider_id", "service_category_skill_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_064ec70fe7a185d0a63c3c8221" ON "service_provider_skills" ("service_provider_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_2ea1d746330b98b84b766da847" ON "service_provider_skills" ("service_category_skill_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "service_category_skills" ADD CONSTRAINT "FK_b85ac3c34b9d49666e70aeb9b38" FOREIGN KEY ("service_category_id") REFERENCES "service_categories"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "service_providers" ADD CONSTRAINT "FK_4e7a5d046f361d1a148b9ce5fe8" FOREIGN KEY ("profile_id") REFERENCES "profiles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "clients" ADD CONSTRAINT "FK_826d0742803aba8b2bcfd32c1c3" FOREIGN KEY ("profile_id") REFERENCES "profiles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "service_provider_jobs" ADD CONSTRAINT "FK_e22ce0c4a93a1275402ab19ebb7" FOREIGN KEY ("service_provider_id") REFERENCES "service_providers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "service_provider_jobs" ADD CONSTRAINT "FK_5ad9e14e5a68bf11f9e52501cde" FOREIGN KEY ("service_category_skill_id") REFERENCES "service_category_skills"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "requested_services" ADD CONSTRAINT "FK_d56f10ec99e6917468681e6beb4" FOREIGN KEY ("service_provider_job_id") REFERENCES "service_provider_jobs"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "requested_services" ADD CONSTRAINT "FK_bf4f130ae9a673133ed3bb865b4" FOREIGN KEY ("client_id") REFERENCES "clients"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "reviews" ADD CONSTRAINT "FK_005bd60144bfe6c2be146681f59" FOREIGN KEY ("service_provider_id") REFERENCES "service_providers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "reviews" ADD CONSTRAINT "FK_d04da5c840cfcf2aeed153b576f" FOREIGN KEY ("requested_service_id") REFERENCES "requested_services"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "review_replies" ADD CONSTRAINT "FK_4b343f41daa49ce42b5b07d77e3" FOREIGN KEY ("review_id") REFERENCES "reviews"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "reports" ADD CONSTRAINT "FK_bda44e16992191ff11ad8da01e2" FOREIGN KEY ("client_id") REFERENCES "clients"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "reports" ADD CONSTRAINT "FK_2ce65e1ecb3ff639d34b07a97b2" FOREIGN KEY ("service_provider_id") REFERENCES "service_providers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "offers" ADD CONSTRAINT "FK_197c0a68e7feaa3af0559d8b2d4" FOREIGN KEY ("client_id") REFERENCES "clients"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "offers" ADD CONSTRAINT "FK_ac4799bcc94e852d5f782ea9c5f" FOREIGN KEY ("service_provider_id") REFERENCES "service_providers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "service_provider_skills" ADD CONSTRAINT "FK_064ec70fe7a185d0a63c3c82212" FOREIGN KEY ("service_provider_id") REFERENCES "service_providers"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "service_provider_skills" ADD CONSTRAINT "FK_2ea1d746330b98b84b766da847c" FOREIGN KEY ("service_category_skill_id") REFERENCES "service_category_skills"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "service_provider_skills" DROP CONSTRAINT "FK_2ea1d746330b98b84b766da847c"`);
        await queryRunner.query(`ALTER TABLE "service_provider_skills" DROP CONSTRAINT "FK_064ec70fe7a185d0a63c3c82212"`);
        await queryRunner.query(`ALTER TABLE "offers" DROP CONSTRAINT "FK_ac4799bcc94e852d5f782ea9c5f"`);
        await queryRunner.query(`ALTER TABLE "offers" DROP CONSTRAINT "FK_197c0a68e7feaa3af0559d8b2d4"`);
        await queryRunner.query(`ALTER TABLE "reports" DROP CONSTRAINT "FK_2ce65e1ecb3ff639d34b07a97b2"`);
        ...
        await queryRunner.query(`ALTER TABLE "reviews" DROP CONSTRAINT "FK_d04da5c840cfcf2aeed153b576f"`);
        await queryRunner.query(`ALTER TABLE "reviews" DROP CONSTRAINT "FK_005bd60144bfe6c2be146681f59"`);
        await queryRunner.query(`ALTER TABLE "reviews" DROP CONSTRAINT "FK_d4e7e923e6bb78a8f0add754493"`);
        await queryRunner.query(`ALTER TABLE "requested_services" DROP CONSTRAINT "FK_bf4f130ae9a673133ed3bb865b4"`);
        await queryRunner.query(`ALTER TABLE "requested_services" DROP CONSTRAINT "FK_d56f10ec99e6917468681e6beb4"`);
        await queryRunner.query(`ALTER TABLE "service_provider_jobs" DROP CONSTRAINT "FK_5ad9e14e5a68bf11f9e52501cde"`);
        await queryRunner.query(`ALTER TABLE "service_provider_jobs" DROP CONSTRAINT "FK_e22ce0c4a93a1275402ab19ebb7"`);
        await queryRunner.query(`ALTER TABLE "clients" DROP CONSTRAINT "FK_826d0742803aba8b2bcfd32c1c3"`);
        await queryRunner.query(`ALTER TABLE "service_providers" DROP CONSTRAINT "FK_4e7a5d046f361d1a148b9ce5fe8"`);
        await queryRunner.query(`ALTER TABLE "service_category_skills" DROP CONSTRAINT "FK_b85ac3c34b9d49666e70aeb9b38"`);
        await queryRunner.query(`ALTER TABLE "profiles" DROP CONSTRAINT "FK_9e432b7df0d182f8d292902d1a2"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_2ea1d746330b98b84b766da847"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_064ec70fe7a185d0a63c3c8221"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."requested_services_status_enum"`);
        await queryRunner.query(`DROP TABLE "service_provider_jobs"`);
        await queryRunner.query(`DROP TABLE "clients"`);
        await queryRunner.query(`DROP TABLE "service_providers"`);
        await queryRunner.query(`DROP TYPE "public"."service_providers_verificationstatus_enum"`);
        await queryRunner.query(`DROP TYPE "public"."service_providers_idtype_enum"`);
