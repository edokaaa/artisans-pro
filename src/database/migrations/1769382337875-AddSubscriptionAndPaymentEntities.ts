...
export class AddSubscriptionAndPaymentEntities1769382337875 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_2c47f5df06175daa620dab983a" ON "subscriptions" ("service_provider_id", "status") `);
        await queryRunner.query(`CREATE TYPE "public"."payments_purpose_enum" AS ENUM('subscription', 'offer')`);
        await queryRunner.query(`CREATE TYPE "public"."payments_status_enum" AS ENUM('pending', 'success', 'failed', 'reversed')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_c96a63d98681cc603f7300deeb" ON "payments" ("sessionId") `);
        await queryRunner.query(`CREATE TYPE "public"."escrows_status_enum" AS ENUM('held', 'released', 'refunded')`);
        ...
        await queryRunner.query(`ALTER TABLE "offers" ADD "escrowStatus" character varying`);
        await queryRunner.query(`ALTER TABLE "offers" ADD "cancellationReason" character varying`);
        await queryRunner.query(`ALTER TYPE "public"."offers_status_enum" RENAME TO "offers_status_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."offers_status_enum" AS ENUM('pending', 'accepted', 'declined', 'pending_payment', 'payment_made', 'completed', 'cancelled')`);
        ...
        await queryRunner.query(`ALTER TABLE "subscriptions" ADD CONSTRAINT "FK_ef382f2b9db4047517d6de7df30" FOREIGN KEY ("service_provider_id") REFERENCES "service_providers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "subscriptions" ADD CONSTRAINT "FK_a442b5ac4f7a8f51a64b2060c48" FOREIGN KEY ("subscription_plan_id") REFERENCES "subscription_plans"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "escrows" ADD CONSTRAINT "FK_ab261fdd66300f0671f782bc8a0" FOREIGN KEY ("offer_id") REFERENCES "offers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "escrows" DROP CONSTRAINT "FK_ab261fdd66300f0671f782bc8a0"`);
        await queryRunner.query(`ALTER TABLE "subscriptions" DROP CONSTRAINT "FK_a442b5ac4f7a8f51a64b2060c48"`);
        await queryRunner.query(`ALTER TABLE "subscriptions" DROP CONSTRAINT "FK_ef382f2b9db4047517d6de7df30"`);
        await queryRunner.query(`CREATE TYPE "public"."offers_status_enum_old" AS ENUM('pending', 'accepted', 'declined', 'pending_payment', 'payment_made')`);
        await queryRunner.query(`ALTER TABLE "offers" ALTER COLUMN "status" DROP DEFAULT`);
        ...
        await queryRunner.query(`ALTER TABLE "offers" DROP COLUMN "cancellationReason"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_c96a63d98681cc603f7300deeb"`);
        await queryRunner.query(`DROP TABLE "payments"`);
        await queryRunner.query(`DROP TYPE "public"."payments_status_enum"`);
        await queryRunner.query(`DROP TYPE "public"."payments_purpose_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_2c47f5df06175daa620dab983a"`);
